document.addEventListener("DOMContentLoaded", function () {
  ...
  const translateDelay = translate.translateDelay || 0; // 延迟时间，默认为0
  ...
  const rightMenuMsgToTraditionalChinese = translate.rightMenuMsgToTraditionalChinese; // 此处可以更改为你想要显示的文字
  const rightMenuMsgToSimplifiedChinese = translate.rightMenuMsgToSimplifiedChinese; // 同上，但两处均不建议更改
