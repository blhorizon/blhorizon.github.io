...
//     data: {
//         key: 'WL3BZ-K4CLS-TZUOR-6KKWI-TNIP5-YABBN',
//         output: 'jsonp',
//     },
//     dataType: 'jsonp',
...
//     let dist = getDistance(114.412599,23.079404, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
...
//             `欢迎来自 <b><span style="color: #49b1f5;font-size: 16px!important;">${pos}</span></b> 的小友💖<br>${posdesc}🍂<br>当前位置距博主约 <b><span style="color: #49b1f5">${dist}</span></b> 公里！<br>您的IP地址为：<b><span>${ip}</span></b><br>${timeChange} <br>`;
//     } catch (err) {
...
function showWelcome() {
    ...
    let dist = getDistance(114.412599, 23.079404, ipLocation.data.lng, ipLocation.data.lat); //修改自己的经度（121.413921）纬度（31.089290）
